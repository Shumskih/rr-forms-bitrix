...
<? if ($arResult["isFormNote"] != "Y") { ?>
    ...
    <div class="form-check mb-3 mt-3 ">
        <?
        if (strpos($arQuestion["HTML_CODE"], 'type="checkbox"') !== false)
            $arQuestion["HTML_CODE"] = substr($arQuestion["HTML_CODE"], 0, 22) . " class='form-check-input' " . substr($arQuestion["HTML_CODE"], 22);
        ?>
        <?= $arQuestion["HTML_CODE"] ?><? if ($arQuestion["REQUIRED"] == "Y"): ?><?= $arResult["REQUIRED_SIGN"]; ?><? endif; ?>
    </div>
